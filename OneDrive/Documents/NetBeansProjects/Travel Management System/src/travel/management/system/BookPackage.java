...
public class BookPackage extends JFrame {
	...
	public BookPackage(String username) {
		...
		contentPane.add(l5);
                ...
                try{
                    Conn c = new Conn();
                    ResultSet rs = c.s.executeQuery("select*from customer6 where username = '"+username+"'");
                    while(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookPackage3 values('"+username+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+l5.getText()+"')";
