...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      String[] package3 = new String[]{"package3.jpg","BRONZE PACKAGE","3 days and 2 Nights", "Return Airfare", "Free Clubbing, Horse Riding & other Games", "Welcome drinks on Arrival", "Daily Buffet", "Stay in 5 Star Hotel", "BBQ Dinner", "BOOK NOW", "Winter Special", "Rs 12000 only"};
